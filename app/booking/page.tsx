...
export default function BookingPage() {
  return (
    <div className="bg-cream h-full w-full flex items-center justify-center py-1 md:py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center space-y-2 md:space-y-8">
          <h1 className="font-heading text-xl md:text-4xl lg:text-5xl font-bold text-blueSoft mb-1 md:mb-6 leading-tight md:leading-normal">
            Book a Facial
          </h1>
          ...
          <div className="pt-1 md:pt-8">
            <div className="bg-cream rounded-lg p-3 md:p-8 lg:p-12">
