    ...
    <div className="bg-cream h-full w-full flex items-center justify-center py-2 md:py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center space-y-6 md:space-y-8">
          <h1 className="font-heading text-lg md:text-4xl lg:text-5xl font-bold text-blueSoft mb-2 md:mb-6 leading-tight md:leading-normal">
            Book a Facial
          </h1>
          ...
          <div className="-mt-2 md:mt-0 md:pt-8">
